...
#### New Features
 ...
 - Clean bootstrap and shutdown allowing to load and unload the addon at will in `worker_threads`n resolves [#69](https://github.com/mmomtchev/pymport/issues/69)
