...
### [1.6.0]
 ...
 - Fix [#438](https://github.com/mmomtchev/pymport/issues/438), event loop may fail to exit in some cases
 - Fix [#502](https://github.com/mmomtchev/pymport/pull/502), event loop may fail to exit in some cases
